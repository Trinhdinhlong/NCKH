        ...
        <div class="row gy-5 gx-4">
            <div class="col-lg-8">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="text-start ps-4">
                        <h3 class="mb-3">Kỹ sư phần mềm PHP</h3>
                        <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i>phường 3,
                            quận Bình Tân,
                            HCM</span>
                ...
                <div class="mb-5">
                    ...
                    <p>Dolor justo tempor duo ipsum accusam rebum gubergren erat. Elitr stet dolor vero clita
                        ...
                        clita et sed consetetur dolore accusam. Vero kasd nonumy justo rebum stet. Ipsum amet sed
                        lorem sea magna. Rebum vero dolores dolores elitr vero dolores magna, stet sea sadipscing
                        stet et. Est voluptua et sanctus at sanctus erat vero sed sed, amet duo no diam clita rebum
                        duo, accusam tempor takimata clita stet nonumy rebum est invidunt stet, dolor.</p>
                    <h4 class="mb-3">Trách nhiệm yêu cầu:</h4>
            ...
            <div class="col-lg-4">
                <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                    ...
                    <p><i class="fa fa-angle-right text-primary me-2"></i>Đăng lúc: 01 Jan, 2045</p>
                    <p><i class="fa fa-angle-right text-primary me-2"></i>Chỗ trống: 123 vị tí</p>
                    <p><i class="fa fa-angle-right text-primary me-2"></i>Thời gian làm việc: Full Time</p>
                    <p><i class="fa fa-angle-right text-primary me-2"></i>Lương: $123 - $456</p>
                    <p><i class="fa fa-angle-right text-primary me-2"></i>Địa điểm: phường 5, Bình Thạnh</p>
                    <p class="m-0"><i class="fa fa-angle-right text-primary me-2"></i>Hạn nộp: 01 Jan, 2045</p>
                </div>
...
<script src="./js/comp-job.js"></script>
<!-- Job Detail End -->